    ...
    return (
        <div className="relative w-full " ref={ref}>
            <input
                ...
                className="w-full h-12 rounded-lg border border-[#D1D5DB] bg-white px-4 pr-10 py-2  text-gray-700 focus:outline-none focus:border-[#D1D5DB]"
                onClick={() => setOpen((o) => !o)}
            />
            {/* Optionally put calendar icon inside input */}
            ...
            {open && (
                <>
                    ...
                    <div className="fixed z-30 left-1/2 top-1/2 w-[40%] max-w-md p-6 rounded-xl bg-white border border-gray-100 shadow-lg
                            ...
                            {days.map((d, idx) =>
                                d ? (
                                    <button
                                        ...
                                        className={`py-2 rounded-lg transition ${selected?.toDateString() === d.toDateString()
